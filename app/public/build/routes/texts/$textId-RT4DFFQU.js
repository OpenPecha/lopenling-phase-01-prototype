...
var annotationMark = (data) => Mark2.create({
  name: "annotation",
  addOptions() {
    return {
      HTMLAttributes: {
  ...
  renderHTML({ HTMLAttributes }) {
    ...
    elem.addEventListener("mouseover", (e) => {
      ...
      annotationContainer == null ? void 0 : annotationContainer.append(createElement);
    });
    elem.addEventListener("mouseleave", (e) => {
      let annotationContainer = document.querySelector(".annotationOptions");
      while (annotationContainer == null ? void 0 : annotationContainer.hasChildNodes()) {
        annotationContainer.removeChild(annotationContainer.firstChild);
      }
    });
    return elem;
...
function TextList({ selectedText }) {
...
var QuestionForm = ({ editor, QuestionArea, openQuestionPortal }, ref) => {
  ...
  console.log(data);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("section", {
    children: [
      data.user ? /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(createQuestion.Form, {
        ref,
        method: "post",
        style: {
          display: "flex",
        ...
        lineNumber: 32,
        columnNumber: 9
      }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", {
        style: { color: "red" },
      ...
      (actionData == null ? void 0 : actionData.message) && /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", {
...
var QuestionForm_default = import_react4.default.forwardRef(QuestionForm);
...
function applyAnnotationFunction(editor, annotation, content) {
  let annotations = annotation;
  let html = "<p>";
  let allkeys = [];
  for (const [key, value] of Object.entries(annotations)) {
  ...
  html += "</p> ";
  editor == null ? void 0 : editor.commands.setContent(html);
}
...
function textId_default() {
  ...
  const indexRef = React3.useRef(1e4);
  const [selectionSpan, setSelectionSpan] = React3.useState(null);
  const [questionRange, setQuestionRange] = React3.useState();
  ...
  const [openQuestionPortal, setOpenQuestionPortal] = React3.useState(false);
  React3.useEffect(() => {
    var _a;
    if (!isAdding) {
  ...
  const [QuestionArea, setQuestionArea] = React3.useState("");
  ...
  const loadMore = () => {
    indexRef.current = indexRef.current + 1e4;
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_jsx_dev_runtime3.Fragment, {
    children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("main", {
      style: {
        marginInline: 40,
        display: "flex",
        flexDirection: "row",
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", {
              className: "annotationOptions"
            }, void 0, false, {
              fileName: "app/routes/texts/$textId.tsx",
              lineNumber: 189,
              columnNumber: 11
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(QuestionList, {
            ...
            openQuestionPortal && /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(QuestionForm_default, {
              editor,
              QuestionArea,
              ref: formRef
            }, void 0, false, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("section", {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(TextList, {
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", {
              ...
              children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(EditorContent, {
                editor
              }, void 0, false, {
                fileName: "app/routes/texts/$textId.tsx",
                lineNumber: 222,
            ...
            data.content.length > 1e4 && /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("button", {
              onClick: loadMore,
              children: "loadmore"
            }, void 0, false, {
              fileName: "app/routes/texts/$textId.tsx",
            ...
            editor && /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(BubbleMenu2, {
 ...
 */
//# sourceMappingURL=/build/routes/texts/$textId-RT4DFFQU.js.map
